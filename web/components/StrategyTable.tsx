      ...
      <div className='space-y-2'>
        ...
        <div className='w-full grid grid-cols-12 gap-4'>
          {strategies.map((entry, index) => (
            <div
              key={index}
              className='bg-indigo-50 border-2 border-indigo-300 hover:bg-white transition-colors duration-200 cursor-pointer w-full rounded-2xl shadow-sm hover:shadow-lg shadow-primary-shadow/20 p-4 col-span-12 space-y-3'
