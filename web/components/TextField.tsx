    ...
    <div className={clsx("space-y-1", { "w-full": type !== "checkbox" })}>
      ...
      {type === "checkbox" ? (
        ...
        <div className="relative w-full">
          ...
          <input
            className={clsx(
              "focus:ring-3 w-full rounded-lg border border-zinc-500 p-4 text-sm text-white outline-none transition-all placeholder:text-white/50 focus:border-cyan-500 focus:ring-cyan-500/20",
              props.disabled
