  ...
  return (
    <Listbox {...listboxProps}>
      <div className='relative'>
        <Listbox.Button className='text-sm leading-none flex space-x-1 bg-white border-2 border-indigo-100 hover:text-indigo-600 px-3 py-1.5 hover:bg-indigo-100 transition-colors duration-500 ease-in-out rounded-md'>
          <div>{field.value}</div>
